...
<body class="">
  <main class="main-content mt-0"
    style="background-image: url('/assets/img/itenas-depan.png'); background-position: top; background-size:cover">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-5 text-center mx-auto">
            ...
            <p class="text-lead text-white">Create an account to continue register. Please
              fill in the registration form below.</p>
          </div>
        </div>
      </div>
    </div>
