        ...
        <div class="row">
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              {{-- <select name="country" value="" class="form-select" style="width: 100%; height: 100%"></select> --}}
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="file" class="dropify form-control" data-height="100" name="high_school_certif" />
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
